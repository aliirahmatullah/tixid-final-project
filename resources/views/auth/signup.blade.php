...
<body>
  <form class="w-50 d-block m-auto my-5" method="POST" action="{{ route('signup.register') }}">
    {{--csrf: generate token yang menjadi syarat bagi fe untuk mengirim data ke server--}}
    @csrf
    <!-- First & Last Name -->
    <div class="row mb-4">
      <div class="col">
        <div data-mdb-input-init class="form-outline">
            {{--name: memberikan data indentitas data agar data yang diinput bisa diakses oleh controller, namanya snack case bahasa inggris--}}
        ...
        {{--error: untuk menampilkan pesan error validasi @error--}}
        @error('first_name')
